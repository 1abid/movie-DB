...
public class SelectableRoundedImageView extends ImageView {
    ...
    public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLeftTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundedImageView_vutka_left_top_corner_radius, 0);
        mRightTopCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundedImageView_vutka_right_top_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundedImageView_vutka_left_bottom_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimensionPixelSize(
                R.styleable.RoundedImageView_vutka_right_bottom_corner_radius, 0);
        ...
        mBorderWidth = a.getDimensionPixelSize(
                R.styleable.RoundedImageView_vutka_border_width, 0);
        if (mBorderWidth < 0) {
            throw new IllegalArgumentException("border width cannot be negative.");
        }

        mBorderColor = a
                .getColorStateList(R.styleable.RoundedImageView_vutka_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(DEFAULT_BORDER_COLOR);
        }

        isOval = a.getBoolean(R.styleable.RoundedImageView_vutka_oval, false);
        a.recycle();
